package com.bitspilani.inventorytrackerjava.DrawingFeature;
...
public class DrawingActivity extends Activity {
        ...
        switch (requestCode) {
            case REQUEST_EXTERNAL_STORAGE: {
                ...
                if (grantResults.length <= 0
                    ...
                    Toast.makeText(DrawingActivity.this, "Cannot write images to external storage", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
    ...
    public boolean addJpgSignatureToGallery(Bitmap signature) {
        ...
        try {
            File photo = new File(getAlbumStorageDir("Track And Trigger"), String.format("Signature_%d.jpg", System.currentTimeMillis()));
